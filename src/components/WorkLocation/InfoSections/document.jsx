...
import AddDocument from 'src/components/Employees/AddEmployeeInfoModals/DocumentAdd/AddDocument'
...
const Document = () => {
  ...
  const handleRemove = async () => {
    ...
    try {
      let res = await request.deleteWorkFolder(req)
      if (res.data) {
  ...
  const checkAll = (e) => {
    if (e) {
      setAllChecked(true)
      setSelectedFoldersId(documents.map((folder) => folder?.folderGuid))
    }
  }
